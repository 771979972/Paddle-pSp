...
from models.loss import id_loss, w_norm, moco_loss
from configs import data_configs
from datasets.images_dataset import ImagesDataset
from models.loss.lpips.lpips import LPIPS
from models.psp import pSp
from models.utils.ranger import Ranger
...
class Coach:
	def __init__(self, opts):
		...
		if self.net.latent_avg is None:
			self.net.latent_avg = self.net.decoder.mean_latent(int(1e5))[0]
		...
		self.logger = LogWriter(log_dir=self.log_dir)
	...
	def configure_optimizers(self):
		...
		if self.opts.optim_name == 'adam':
			...
			optimizer = Ranger(parameters=params, learning_rate=self.opts.learning_rate)
		return optimizer
