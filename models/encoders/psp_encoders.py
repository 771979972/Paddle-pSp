...
from paddle.nn import Linear, Conv2D, BatchNorm2D, PReLU, Sequential, Layer
...
class GradualStyleEncoder(Layer):
    ...
    def _upsample_add(self, x, y):
        ...
        Note in Paddle, when input size is odd, the upsampled feature map
...
class BackboneEncoderUsingLastLayerIntoWPlus(Layer):
    ...
    def forward(self, x):
        ...
        x = self.linear(x)
        x = x.reshape((-1, self.n_styles, 512))
        return x
